...
class quad_node(object):
    ...
    def __init__(self):
        ...
        self.quad_robot_obj = quadrobot_class.quadrobot_class(self.vr, self.kf, self.reverse_direction, self.flag_follow_obstacle, self.epsilon, self.switch_dist_0, self.switch_dist, self.m, self.kv, self.kw,self.robot_number)
    ...
    def init_node(self):
        ...
        self.pub_acrorate = rospy.Publisher(self.acrorate_cmd_topic_name + f"{self.robot_number}", Quaternion, queue_size=1)
